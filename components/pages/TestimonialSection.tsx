...
const testimonials: Testimonial[] = [
    {
        id: 1,
        name: "Rene B. Brown",
        avatar: "/images/Testimonials/pic-01.jpg",
        review:
    ...
    },
    {
        id: 2,
        name: "James D. Perez",
        avatar: "/images/Testimonials/pic-02.jpg",
        review:
    ...
    },
    {
        id: 3,
        name: "Vicki R. Baker",
        avatar: "/images/Testimonials/pic-03.jpg",
        review:
    ...
    {
        id: 4,
        name: "Michael T. Hayes",
        avatar: "/images/Testimonials/pic-04.jpg",
        review:
            "The team at Authors Book Publishing exceeded my expectations at every turn. From editing to final distribution, they handled everything professionally. My book is now available on all major platforms.",
    },
    {
        id: 5,
        name: "Sarah L. Morgan",
        avatar: "/images/Testimonials/pic-05.jpg",
        review:
            "Working with Authors Book Publishing was an incredible experience. They understood my vision perfectly and helped bring it to life. The cover design and formatting were absolutely stunning.",
    },
    {
        id: 6,
        name: "David K. Wilson",
        avatar: "/images/Testimonials/pic-06.jpg",
        review:
            "I had struggled with self-publishing for years before finding Authors Book Publishing. Their expert team made the entire process seamless and my book reached readers worldwide within weeks.",
    },
];
...
const TestimonialsSection2: React.FC = () => {
    ...
    return (
        <>
            <style jsx global>{`
                .testimonials2-swiper {
                    width: 100%;
                    overflow: visible !important;
                    padding: 30px 0 40px !important;
                }
                .testimonials2-swiper .swiper-slide-active .test2-card {
                    transform: scale(1.08);
                    box-shadow: 0 16px 44px rgba(0, 0, 0, 0.14);
                    z-index: 2;
                }
                .testimonials2-swiper .swiper-slide:not(.swiper-slide-active) .test2-card {
