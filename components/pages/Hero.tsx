    ...
    return (
        <section className="hero">
            <div className="hero-bg">
                <Image src="/images/hero.jpg" alt="Book covers background" fill priority style={{ objectFit: "cover", objectPosition: "center" }} />
            ...
            <style jsx>{`
                ...
                .hero-desc { font-size: 14px; color: rgba(255,255,255,0.75); line-height: 1.8; margin-bottom: 32px; max-width: 560px; }
