        ...
        <>
            ...
            <section className="pg-hero">
                <div className="pg-hero-bg">
                    <Image src="/images/hero.jpg" alt="Book Marketing" fill priority style={{ objectFit: "cover" }} />
                    <div className="pg-overlay" />
                </div>
                <div className="pg-hero-inner">
                    <p className="pg-crumb">Home / Services / Book Marketing</p>
                    <h1 className="pg-h1">Book Marketing</h1>
                    <p className="pg-hero-sub">Get Your Book In Front Of The Right Readers</p>
                </div>
            </section>
            ...
            <section className="sec light">
                <div className="two-col">
                    <div className="col-text">
                        <span className="badge">Book Marketing</span>
                        <h2 className="hdg dark">Results-Driven Book Marketing That Sells</h2>
                        <div className="odiv" />
                        <p className="para dk">Publishing your book is only the beginning. Without effective marketing, even the best book can go unnoticed. Our book marketing team builds targeted campaigns that put your book in front of the exact readers who are looking for it — driving real sales and building a loyal audience.</p>
                        <p className="para dk">From social media campaigns and email marketing to PPC advertising and author website development, we use a multi-channel approach that keeps your book visible and relevant long after launch day. Every strategy is tailored to your genre, audience, and budget.</p>
                    ...
                    <div className="col-img">
                        <div className="img-frame">
                            <Image src="/images/Marketing.png" alt="Book Marketing" width={520} height={460} style={{ width: "100%", height: "auto", display: "block" }} />
            ...
            <section className="sec dark">
                ...
                <div className="two-col rev">
                    ...
                    <div className="col-text">
                        ...
                        <div className="odiv" />
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Social Media Campaigns</strong><p className="why-d">Targeted campaigns on Instagram, Facebook, TikTok, and X to reach ideal readers.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">PPC Advertising</strong><p className="why-d">Amazon Ads, Facebook Ads, and Google Ads with optimized targeting and ROI tracking.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Email Marketing</strong><p className="why-d">Subscriber list building and email sequences that convert readers into buyers.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Author Website</strong><p className="why-d">Professional author website that builds your publishing hub and online brand.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Book Launch Strategy</strong><p className="why-d">Coordinated launch campaigns generating buzz, reviews, and sales from day one.</p></div></div>
                    </div>
                </div>
            </section>
            ...
            <section className="sec light">
                ...
                <div className="three-col">
                    <div className="light-card"><div className="lc-icon">📱</div><h3 className="lc-title">Social Media Marketing</h3><p className="lc-text">Platform-specific campaigns on Instagram, Facebook, TikTok, and X.</p></div>
                    <div className="light-card"><div className="lc-icon">💰</div><h3 className="lc-title">Amazon Ads</h3><p className="lc-text">Sponsored ads on Amazon that put your book in front of active buyers.</p></div>
                    <div className="light-card"><div className="lc-icon">📧</div><h3 className="lc-title">Email Marketing</h3><p className="lc-text">List building, welcome sequences, and promotional emails that convert.</p></div>
                    <div className="light-card"><div className="lc-icon">🌐</div><h3 className="lc-title">Author Website</h3><p className="lc-text">Professional author website with blog, book pages, and email capture.</p></div>
                    <div className="light-card"><div className="lc-icon">🎬</div><h3 className="lc-title">Book Video Trailer</h3><p className="lc-text">Cinematic book trailers for social media and YouTube.</p></div>
                    <div className="light-card"><div className="lc-icon">📊</div><h3 className="lc-title">Analytics & Reporting</h3><p className="lc-text">Monthly performance reports with clear metrics on reach and sales.</p></div>
                </div>
            </section>
            ...
            <section className="sec dark">
                ...
                <div className="process-row">
                    <div className="p-step"><div className="p-num">01</div><div className="p-title">Audit & Strategy</div><p className="p-desc">We audit your current presence and build a custom marketing strategy.</p></div>
                    <div className="p-step"><div className="p-num">02</div><div className="p-title">Setup & Launch</div><p className="p-desc">Campaign setup, ad creative, and launch preparation across all channels.</p></div>
                    <div className="p-step"><div className="p-num">03</div><div className="p-title">Campaign Management</div><p className="p-desc">Active management and optimization of all campaigns for maximum ROI.</p></div>
                    <div className="p-step"><div className="p-num">04</div><div className="p-title">Reviews & PR</div><p className="p-desc">Outreach to reviewers, bloggers, and media to build social proof.</p></div>
                    <div className="p-step"><div className="p-num">05</div><div className="p-title">Reporting</div><p className="p-desc">Monthly reports with clear data on performance and improvements.</p></div>
                </div>
            </section>

            {/* 6 — CTA: ORANGE */}
            <section className="service-banner">
                <h2 className="sb-h2">Ready To Market Your Book Like A Bestseller?</h2>
                <p className="sb-p">Get a free marketing consultation and find out which channels will work best for your book.</p>
