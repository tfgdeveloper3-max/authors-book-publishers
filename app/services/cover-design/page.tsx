        ...
        <>
            ...
            <section className="pg-hero">
                <div className="pg-hero-bg">
                    <Image src="/images/hero.jpg" alt="Book Cover Design" fill priority style={{ objectFit: "cover" }} />
                    <div className="pg-overlay" />
                </div>
                <div className="pg-hero-inner">
                    <p className="pg-crumb">Home / Services / Cover Design</p>
                    <h1 className="pg-h1">Book Cover Design</h1>
                    <p className="pg-hero-sub">Covers That Stop Readers & Drive Sales</p>
                </div>
            </section>
            ...
            <section className="sec light">
                <div className="two-col">
                    <div className="col-text">
                        <span className="badge">Cover Design</span>
                        <h2 className="hdg dark">Professional Book Cover Design That Sells</h2>
                        <div className="odiv" />
                        <p className="para dk">Readers always judge a book by its cover. A professionally designed book cover is the single most important marketing tool for your book. Our designers create covers that instantly communicate your genre, attract your audience, and look stunning in print and digital formats.</p>
                        <p className="para dk">We combine typography mastery, color psychology, and market research to create covers that don't just look beautiful but actually sell books. Every cover is designed with your specific genre conventions and target reader in mind.</p>
                    ...
                    <div className="col-img">
                        <div className="img-frame">
                            <Image src="/images/give-story-img.webp" alt="Book Cover Design" width={520} height={460} style={{ width: "100%", height: "auto", display: "block" }} />
            ...
            <section className="sec dark">
                ...
                <div className="two-col rev">
                    ...
                    <div className="col-text">
                        ...
                        <div className="odiv" />
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Genre-Specific Design</strong><p className="why-d">Covers designed with knowledge of what sells in your specific genre.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Multiple Concepts</strong><p className="why-d">We provide multiple initial design concepts so you choose the direction you love.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Print & Digital Ready</strong><p className="why-d">Files in all formats — print-ready PDF, Kindle cover, ebook thumbnail, and more.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Unlimited Revisions</strong><p className="why-d">We revise until you are 100% satisfied with every detail of your cover.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Professional Typography</strong><p className="why-d">Hand-selected fonts and lettering that make your title and name stand out.</p></div></div>
                    </div>
                </div>
            </section>
            ...
            <section className="sec light">
                ...
                <div className="three-col">
                    <div className="light-card"><div className="lc-icon">🎨</div><h3 className="lc-title">Front Cover Design</h3><p className="lc-text">Eye-catching front cover with professional typography and genre-appropriate design.</p></div>
                    <div className="light-card"><div className="lc-icon">📚</div><h3 className="lc-title">Full Wrap Design</h3><p className="lc-text">Complete front, spine, and back cover design for print books.</p></div>
                    <div className="light-card"><div className="lc-icon">📱</div><h3 className="lc-title">Ebook Covers</h3><p className="lc-text">Optimized digital covers that look stunning as thumbnails on all platforms.</p></div>
                    <div className="light-card"><div className="lc-icon">✍️</div><h3 className="lc-title">Custom Typography</h3><p className="lc-text">Hand-crafted title treatments that make your book title unforgettable.</p></div>
                    <div className="light-card"><div className="lc-icon">🖼️</div><h3 className="lc-title">Author Branding</h3><p className="lc-text">Consistent visual branding across your book series, website, and social media.</p></div>
                    <div className="light-card"><div className="lc-icon">🖨️</div><h3 className="lc-title">Print Optimization</h3><p className="lc-text">Print-ready files with proper bleed, trim, and color profiles.</p></div>
                </div>
            </section>
            ...
            <section className="sec dark">
                ...
                <div className="process-row">
                    <div className="p-step"><div className="p-num">01</div><div className="p-title">Design Brief</div><p className="p-desc">We gather details about your book, genre, audience, and visual preferences.</p></div>
                    <div className="p-step"><div className="p-num">02</div><div className="p-title">Research & Concepts</div><p className="p-desc">We research comparable titles and create multiple initial concept directions.</p></div>
                    <div className="p-step"><div className="p-num">03</div><div className="p-title">Design Presentation</div><p className="p-desc">We present your concepts and explain the thinking behind each one.</p></div>
                    <div className="p-step"><div className="p-num">04</div><div className="p-title">Refinement</div><p className="p-desc">We refine your chosen concept based on your detailed feedback.</p></div>
                    <div className="p-step"><div className="p-num">05</div><div className="p-title">Final Files</div><p className="p-desc">All final print and digital files delivered in every format you need.</p></div>
                </div>
            </section>

            {/* 6 — CTA: ORANGE */}
            <section className="service-banner">
                <h2 className="sb-h2">Ready For A Cover That Sells Your Book?</h2>
                <p className="sb-p">Get started with a free design consultation and see how we approach your cover.</p>
