...
//     title: "Book Editing Services | Authors Book Publishing",
//     description: "Professional manuscript editing and proofreading services for authors across all genres.",
// };
        ...
        <>
            ...
            <section className="pg-hero">
                <div className="pg-hero-bg">
                    <Image src="/images/hero.jpg" alt="Book Editing Services" fill priority style={{ objectFit: "cover" }} />
                    <div className="pg-overlay" />
                </div>
                <div className="pg-hero-inner">
                    <p className="pg-crumb">Home / Services / Book Editing</p>
                    <h1 className="pg-h1">Book Editing Services</h1>
                    <p className="pg-hero-sub">Polish Your Manuscript To Publishing Perfection</p>
                </div>
            </section>
            ...
            <section className="sec light">
                <div className="two-col">
                    <div className="col-text">
                        <span className="badge">Book Editing</span>
                        <h2 className="hdg dark">Professional Editing & Proofreading For Every Author</h2>
                        <div className="odiv" />
                        <p className="para dk">Even the greatest writers need an editor. Our comprehensive editing services cover every stage — from big-picture structural issues to sentence-level grammar and spelling. We ensure your manuscript is polished, consistent, and publication-ready.</p>
                        <p className="para dk">Our editors are genre specialists who bring both technical expertise and a passion for storytelling. We strengthen your narrative, clarify your message, and ensure your book makes the best impression on every reader.</p>
                    ...
                    <div className="col-img">
                        <div className="img-frame">
                            <Image src="/images/cta-sec-img-1.webp" alt="Book Editing Services" width={520} height={460} style={{ width: "100%", height: "auto", display: "block" }} />
            ...
            <section className="sec dark">
                ...
                <div className="two-col rev">
                    ...
                    <div className="col-text">
                        ...
                        <div className="odiv" />
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Developmental Editing</strong><p className="why-d">Big-picture feedback on structure, pacing, plot, and characters.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Copy Editing</strong><p className="why-d">Line-by-line grammar, syntax, style, and consistency review.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Proofreading</strong><p className="why-d">Final check for typos, punctuation, and formatting issues.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Genre Expertise</strong><p className="why-d">Editors who specialize in your genre and understand its conventions.</p></div></div>
                        <div className="why-row"><span className="why-ck">&#10003;</span><div><strong className="why-t">Track Changes</strong><p className="why-d">All edits delivered with track changes so you control every decision.</p></div></div>
                    </div>
                </div>
            </section>
            ...
            <section className="sec light">
                ...
                <div className="three-col">
                    <div className="light-card"><div className="lc-icon">🔍</div><h3 className="lc-title">Developmental Editing</h3><p className="lc-text">Big-picture structural feedback on plot, pacing, and narrative flow.</p></div>
                    <div className="light-card"><div className="lc-icon">✏️</div><h3 className="lc-title">Copy Editing</h3><p className="lc-text">Line-by-line grammar, syntax, and style corrections throughout your manuscript.</p></div>
                    <div className="light-card"><div className="lc-icon">🔎</div><h3 className="lc-title">Proofreading</h3><p className="lc-text">Final-stage review catching every remaining typo and formatting issue.</p></div>
                    <div className="light-card"><div className="lc-icon">📐</div><h3 className="lc-title">Formatting Review</h3><p className="lc-text">Ensuring your manuscript meets publishing platform requirements.</p></div>
                    <div className="light-card"><div className="lc-icon">💬</div><h3 className="lc-title">Beta Reading</h3><p className="lc-text">Audience-perspective feedback on readability and engagement.</p></div>
                    <div className="light-card"><div className="lc-icon">📋</div><h3 className="lc-title">Style Guide</h3><p className="lc-text">Consistent style guide keeping your manuscript coherent across all chapters.</p></div>
                </div>
            </section>
            ...
            <section className="sec dark">
                ...
                <div className="process-row">
                    <div className="p-step"><div className="p-num">01</div><div className="p-title">Sample Edit</div><p className="p-desc">We edit a sample chapter so you see our approach before committing.</p></div>
                    <div className="p-step"><div className="p-num">02</div><div className="p-title">Full Assessment</div><p className="p-desc">A detailed editorial report on strengths and improvement areas.</p></div>
                    <div className="p-step"><div className="p-num">03</div><div className="p-title">Editing Rounds</div><p className="p-desc">Multiple editing passes covering different aspects of your manuscript.</p></div>
                    <div className="p-step"><div className="p-num">04</div><div className="p-title">Author Review</div><p className="p-desc">You review all edits and accept or reject changes with our guidance.</p></div>
                    <div className="p-step"><div className="p-num">05</div><div className="p-title">Final Delivery</div><p className="p-desc">Clean, polished manuscript ready for typesetting or direct publishing.</p></div>
                </div>
            </section>

            {/* 6 — CTA: ORANGE */}
            <section className="service-banner">
                <h2 className="sb-h2">Ready For A Professionally Edited Manuscript?</h2>
                <p className="sb-p">Submit your manuscript today and get a free sample edit of your first chapter.</p>
